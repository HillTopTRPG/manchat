...
class Api::V1::RoomsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create api_v1_room" do
    assert_difference("Api::V1::Room.count") do
      post api_v1_rooms_url, params: { api_v1_room: { last_logged_in: @api_v1_room.last_logged_in, name: @api_v1_room.name, password: @api_v1_room.password, uuid: @api_v1_room.uuid } }
    end
  ...
  test "should update api_v1_room" do
    patch api_v1_room_url(@api_v1_room), params: { api_v1_room: { last_logged_in: @api_v1_room.last_logged_in, name: @api_v1_room.name, password: @api_v1_room.password, uuid: @api_v1_room.uuid } }
