    ...
    class RoomsController < ApplicationController
      ...
      def create
        ...
        if api_v1_room.save
          ...
          api_v1_token.save
          render json: { success: true, room_token: api_v1_token.token, room: api_v1_room.attributes.reject do |key|
                                                                                key == 'password'
                                                                              end }
        else
      ...
      def login
        ...
        unless BCrypt::Password.new(api_v1_room.password).is_password?(params[:password])
      ...
      def check_token
        ...
        unless Api::V1::Token.valid.check_room(
          ...
          render json: { verify: 'failed',
                         reason: 'expired_room_token' } and return
        end
