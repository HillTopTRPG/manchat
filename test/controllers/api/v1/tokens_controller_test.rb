  ...
  module V1
    class TokensControllerTest < ActionDispatch::IntegrationTest
      ...
      test 'should create api_v1_token' do
        assert_difference('Api::V1::Token.count') do
          post api_v1_tokens_url,
               params: { api_v1_token: { target_type: @api_v1_token.target_type, target_uuid: @api_v1_token.target_uuid,
                                         token: @api_v1_token.token } }
        end
      ...
      test 'should update api_v1_token' do
        patch api_v1_token_url(@api_v1_token),
              params: { api_v1_token: { target_type: @api_v1_token.target_type, target_uuid: @api_v1_token.target_uuid,
                                        token: @api_v1_token.token } }
