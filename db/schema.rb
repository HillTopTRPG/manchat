...
ActiveRecord::Schema[7.0].define(version: 20_220_907_004_932) do
  ...
  create_table 'api_v1_users_channel_subscribers', charset: 'utf8mb4', collation: 'utf8mb4_0900_ai_ci',
                                                   force: :cascade do |t|
