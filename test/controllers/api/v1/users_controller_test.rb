...
class Api::V1::UsersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create api_v1_user" do
    assert_difference("Api::V1::User.count") do
      post api_v1_users_url, params: { api_v1_user: { last_logged_in: @api_v1_user.last_logged_in, name: @api_v1_user.name, password: @api_v1_user.password, uid: @api_v1_user.uid } }
    end
  ...
  test "should update api_v1_user" do
    patch api_v1_user_url(@api_v1_user), params: { api_v1_user: { last_logged_in: @api_v1_user.last_logged_in, name: @api_v1_user.name, password: @api_v1_user.password, uid: @api_v1_user.uid } }
